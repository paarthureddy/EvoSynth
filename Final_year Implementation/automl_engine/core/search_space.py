...
def get_xgboost_search_space():
    ...
    colsample = CSH.UniformFloatHyperparameter("colsample_bytree", lower=0.3, upper=1.0)
    reg_alpha = CSH.UniformFloatHyperparameter("reg_alpha", lower=0.0, upper=10.0)

    cs.add_hyperparameters([lr, n_est, depth, sub, booster, colsample, reg_alpha])
    return cs